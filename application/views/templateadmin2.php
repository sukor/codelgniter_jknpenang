...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="<?= base_url('themeadmin2/vendor/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet">

    <!-- MetisMenu CSS -->

    <link href="<?= base_url('themeadmin2/vendor/metisMenu/metisMenu.min.css') ?>" rel="stylesheet">
